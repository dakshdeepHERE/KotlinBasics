...
//        val queue = if (isFaculty) facultyQueue else studentQueue
...
//                val queryTime = ChronoUnit.MINUTES.between(query.timeRequested, currentTime).coerceAtLeast(0)
...
//    println("Handled $numQueries queries with an average time of ${avgQueryTime.coerceAtLeast(0.0)} minutes.")
//}
